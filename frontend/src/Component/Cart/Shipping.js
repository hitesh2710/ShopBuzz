...
function Shipping() {
  ...
  const shippingSubmit = (e) => {
    ...
    dispatch(saveShippingInfo({address,phoneNo,state,pinCode,city,country}))
            ...
            <div>
              ...
              >
                ...
                {Country.getAllCountries().map((items) => (
                  <option key={items.isoCode} value={items.isoCode}>
                    {items.name}
                  </option>
                ))}
              </select>
            ...
            {country && (
              <div>
                ...
                >
                  ...
                  {}
                  {State.getStatesOfCountry(country).map((items) => (
                    <option key={items.isoCode} value={items.isoCode}>
                      {items.name}
                    </option>
                  ))}
